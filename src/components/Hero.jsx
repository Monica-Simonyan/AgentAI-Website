...
const Hero = () => {
  return (
      ...
      lg:px-24 xl-px:40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
          ...
          <p className='text-sm sm:text-1g font-medium text-gray-500 dark: text-white/ 75 max-w-4/5 sm: max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.</p>
