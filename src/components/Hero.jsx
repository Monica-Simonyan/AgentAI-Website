  ...
  return (
      ...
      lg:px-24 xl-px:40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
          ...
          <motion.h1 initial={{ opacity: 0, y: 40 }}
              ...
              ransition={{ duration: 0.6, delay: 0.8 }}
               viewport={{once:true}}
          ...
          <motion.p
              ...
              whileInView={{ opacity: 1, y: 0 }}
              ransition={{ duration: 0.5, delay: 1 }}
               viewport={{once:true}}
              className='text-sm sm:text-1g font-medium text-gray-500 dark: text-white/ 75 max-w-4/5 sm: max-w-lg pb-3'>Creating meaningful connections and turning big ideas into interactive digital experiences.</motion.p>
          <motion.div
              initial={{ opacity: 0, scale:0.9 }}
              whileInView={{ opacity: 1, scale:1 }}
              ransition={{ duration: 0.6, delay: 2 }}
               viewport={{once:true}}
              className='relative'>
