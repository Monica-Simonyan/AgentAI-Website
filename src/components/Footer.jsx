...
const Footer = ({theme}) => {
  return (
      <motion.div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 
      sm:px-10 lg:px-24 xl:px-0'
      initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8}}
          viewport={{once:true}}>
          <div className='flex flex-col justify-between lg:flex-row lg:items-start gap-10'>
          ...
          <div className='pb-6 text-sm text-gray-500 flex justify-center sm:justify-between gap-4 flex-wrap'>
              <p>Copyright 2026 © agency.io GreatStack - All Right Reserved.</p>
